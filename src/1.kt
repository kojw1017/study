...
class Rational private constructor(
    ...
    operator fun times(r: Rational) = of(sign*r.sign*num*r.num, den*r.den)
    operator fun div(r: Rational)=  of(sign*r.sign*num*r.den, den*r.num)
    override fun toString() = "${sign*num}" + if(den != 1) "/$den" else ""
    companion object{
